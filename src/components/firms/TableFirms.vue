<template>
    ...
    <div class="table-container">
        <table>
            ...
            <tr v-else v-for="content in filteredContents" :key="content">
                <td>
                    {{content.name}}
                </td>
                <td>
...
export default {    
    ...
    data(){
        return {
            ...
            search:'',
            titles:['NAME','ESTD YEAR','TELEPHONE','MAIL','ADDRESS','BANK ACC','BANK NAME','INN NUMBER','LOGO','DIRECTOR'],
        }
    },
    computed:{
        filteredContents(){
            return this.contents.filter((content)=>{
                return content.name.match(this.search) || content.director.match(this.search) || content.telephone.match(this.search)
            })
        },
        getToken(){
    ...
    methods:{
        load(){console.log(this.getLoader)},
        toggleSearchBox(){
        ...
        deleteItem(id){
            ...
            if(confirm("do you want to delete?")){
                axios.delete("https://bspacedev.azurewebsites.net/api/Firms/Delete/"+id,
                {
                        headers: {
                            'Accept':'text/plain',
        ...
        async editItem(id){
            await axios.get("https://bspacedev.azurewebsites.net/api/Firms/GetById?id="+id,
            {
                    headers: {
                        'Accept':'text/plain',
                        "Authorization" : `Bearer ${localStorage.getItem("mytoken")}`
