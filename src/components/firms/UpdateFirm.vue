            ...
            <form @submit.prevent>
                <div class="form-add">
                    ...
                    <div class="input-container">
                        ...
                        <firms-drop-down :options="getParentFirms" @sendId="getId($event)" firm="true" :update="name"></firms-drop-down>
                    </div>
                    <div class="input-container">
                    ...
                    <div class="input-container">
                        ...
                        <input v-model="bankAccount" type="text" placeholder="Input Bank Account">
                    </div>
                    <div class="input-container">
                    ...
                    <div class="input-container">
                        ...
                        <input v-model="director" type="text" placeholder="Input Diresctor's name">
                    </div>
                </div>
                <div class="sub-container">
                    <div class="input-container">
                            <label>Logotype</label>
                            <input type="file" @change="previewFiles" ref="logo" style="display: none">
                            <button id="my-file" @click.stop="$refs.logo.click()">
                                Upload File
                                <fa class="icons" :icon="['fas', 'upload']" /> <!-- this.$refs.logo.value -->
                            </button>
                        </div>
                        <div class="btn-add">
...
export default {
    ...
    methods:{
        ...
        updateFirm(){
            ...
            axios.put("https://bspacedev.azurewebsites.net/api/Firms/Update",
            {
                "id": this.id,
                "parentCompanyId": this.editedData.parentCompanyId,
                "name": this.name,
